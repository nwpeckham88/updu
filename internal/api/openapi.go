...
func baseOpenAPIRoutes() []openAPIRoute {
	return sortOpenAPIRoutes([]openAPIRoute{
		...
		{Method: "POST", Path: "/api/v1/heartbeat/{slug}", Tag: "Heartbeat", Summary: "Report a heartbeat ping by monitor slug", Parameters: []openAPIParameter{pathParameter("slug", "Heartbeat monitor slug.")}, SuccessStatus: "200", SuccessResponse: genericJSONResponse("Heartbeat accepted."), ErrorStatuses: []string{"404", "500"}},
		{Method: "GET", Path: "/heartbeat/{token}", Tag: "Heartbeat", Summary: "Trigger a heartbeat using the simplified token route", Parameters: []openAPIParameter{pathParameter("token", "Heartbeat token.")}, SuccessStatus: "200", SuccessResponse: genericJSONResponse("Heartbeat accepted."), ErrorStatuses: []string{"404", "500"}},
		{Method: "POST", Path: "/heartbeat/{token}", Tag: "Heartbeat", Summary: "Post a heartbeat using the simplified token route", Parameters: []openAPIParameter{pathParameter("token", "Heartbeat token.")}, SuccessStatus: "200", SuccessResponse: genericJSONResponse("Heartbeat accepted."), ErrorStatuses: []string{"404", "500"}},
		{Method: "PUT", Path: "/heartbeat/{token}", Tag: "Heartbeat", Summary: "Update a heartbeat using the simplified token route", Parameters: []openAPIParameter{pathParameter("token", "Heartbeat token.")}, SuccessStatus: "200", SuccessResponse: genericJSONResponse("Heartbeat accepted."), ErrorStatuses: []string{"404", "500"}},
